...
//Imports Routers
import modulets = require("./population/module");
...
import {saveperson} from './population/module'
//Start Express
...
app.use(express.static(path.join(__dirname, './../../client/www')));	//defining static path for current project
